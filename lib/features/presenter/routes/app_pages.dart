...
import 'package:sigma_hort_gestao_equipe/core/middlewares/area_cultivo_middleware.dart';
import 'package:sigma_hort_gestao_equipe/core/middlewares/caderno_middleware.dart';
import 'package:sigma_hort_gestao_equipe/core/middlewares/equipe_middleware.dart';
import 'package:sigma_hort_gestao_equipe/core/middlewares/reservatorio_middleware.dart';
...
import 'package:sigma_hort_gestao_equipe/features/presenter/views/alert/permission_denied_view.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/area_cultivo/N1/cadastrar_area_cultivo_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/area_cultivo/N2/cadastrar_setor_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/area_cultivo/N2/setor_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/area_cultivo/N3/cadastrar_lote_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/area_cultivo/N3/detalhes_lote_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/area_cultivo/N3/lote_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/caderno_campo/cadastrar_caderno_campo_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/caderno_campo/detalhes_caderno_campo_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/gerenciar_equipe/cadastrar_usuario_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/gerenciar_equipe/detalhes_usuario_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/gerenciar_equipe/gerenciar_equipe_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/recuperar_senha/codigo_seguranca_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/recuperar_senha/nova_senha_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/recuperar_senha/recuperacao_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/reservatorio/cadastrar_reservatorio/cadastrar_resevatorio_page.dart';
import 'package:sigma_hort_gestao_equipe/features/presenter/views/reservatorio/detalhes_reservatorio_page.dart';
