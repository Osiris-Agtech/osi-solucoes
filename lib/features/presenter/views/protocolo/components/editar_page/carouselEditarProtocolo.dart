...
import 'package:osi_solucoes/features/presenter/views/protocolo/components/editar_page/editAtivPage.dart';
import 'package:osi_solucoes/features/presenter/views/protocolo/components/editar_page/editCulturaItem.dart';
        ...
        Observer(builder: (_) {
          return CarouselSlider(
            ...
            options: CarouselOptions(
              initialPage: store.dotIndicatorEdit,
                ...
                child: Observer(builder: (_) {
                  return Row(
                    ...
                    children: [
                      Icon(
                        Icons.chevron_left,
                        color: store.dotIndicatorEdit == 0
                            ? Colors.grey
