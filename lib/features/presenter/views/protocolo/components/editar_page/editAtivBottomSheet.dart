...
import 'package:osi_solucoes/features/presenter/views/protocolo/components/editar_page/editFaseBottomSheet.dart';
import 'package:osi_solucoes/features/presenter/widgets/get_bottom_sheet.dart';

class EditAtivBottomSheet extends StatefulWidget {
...
class _EditAtivBottomSheetState extends State<EditAtivBottomSheet> {
            ...
            children: [
                ...
                return Padding(
                  ...
                  child: DropdownButton<Fase>(
                    ...
                    onChanged: (Fase? newValue) {
                      if (newValue != null) {
                        store.alterarDropdownFaseDetalhes(newValue);
                      }
                    },
                    items: store.faseDropDownListDetelhes
              ...
              Observer(builder: (_) {
                return TextFormField(
                  controller: store.novoTituloDetalhesAtividade,
              ...
              Observer(builder: (_) {
                return TextFormField(
                  readOnly: true,
                  controller: store.diaDetalhesAtivController,
                  onTap: () {
                    if (store.selectedDetalhesFase?.nome != null &&
                        store.selectedDetalhesFase?.duracao_dias != null) {
                      getBottomSheet(
                        const EditFaseBottomSheetFaseBottomSheet(),
                      );
                    } else {
                      toastError(
              ...
              Container(
                ...
                child: Observer(builder: (_) {
                  return TextFormField(
                    controller: store.novoDescricaoDetalhesAtividade,
                    textInputAction: TextInputAction.next,
                    maxLines: 4,
                    style: const TextStyle(
                      fontWeight: FontWeight.normal,
                ...
                child: Center(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        store.validarAtividadeDetalhes();
                        if (!store.isValid) {
                          toastError(
                              message:
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Observer(builder: (_) {
                return TextFormField(
                  initialValue: store.novoTituloFaseDetalhes,
                  ...
                  onChanged: store.alterarTituloFaseDetalhes,
                );
              }),
              const SizedBox(height: 16),
              ...
              Observer(builder: (_) {
                return TextFormField(
                  initialValue: store.novoDuracaoDiasFaseDetalhes == null
                      ? ""
                      : store.novoDuracaoDiasFaseDetalhes.toString(),
                  ...
                  onChanged: (value) {
                    if (value != "") {
                      store.alterarDuracaoDiasFaseDetalhes(int.parse(value));
                    }
                  },
                );
              }),
