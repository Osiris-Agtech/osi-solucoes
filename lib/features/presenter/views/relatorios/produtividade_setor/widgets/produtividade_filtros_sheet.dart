...
class ProdutividadeFiltrosSheet extends StatefulWidget {
  final RelatorioProdutividadeFiltros filtrosAtuais;
  final void Function(RelatorioProdutividadeFiltros) onAplicar;

  const ProdutividadeFiltrosSheet({
    super.key,
  ...
  @override
  State<ProdutividadeFiltrosSheet> createState() =>
      _ProdutividadeFiltrosSheetState();
}

class _ProdutividadeFiltrosSheetState
    extends State<ProdutividadeFiltrosSheet> {
            ...
            children: [
              Expanded(
                child: OutlinedButton(
                  onPressed: () {
                    final padrao = RelatorioProdutividadeFiltros.ultimos6Meses();
                    setState(() {
