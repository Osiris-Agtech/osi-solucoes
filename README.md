...
Leia a documentação [sobre o projeto](docs/sobre_o_projeto.md)

## Padrões de desenvolvimento e boas práticas

Leia a documentação [boas praticas](docs/padroes_de_desenvolvimento.md)

## Primeiros passos e comandos

Leia a documentação [primeiros passos](docs/primeiros_passos.md)

## Fluxo de trabalho

Leia a documentação [fluxo de trabalho](docs/fluxo_de_trabalho.md)
 ...
 **Comandos git**
 [adicionar aqui os comandos do git]
